...
import { EVENTS as events, type Event } from "@/lib/mockData";

const categoryFilters: { id: Event["category"] | "all"; label: string }[] = [
...
export default function EventsPage() {
  ...
  const featuredEvent = events.find((e) => e.registerUrl && e.category === "Festival"); // Just pick one, e.g. Festival or use first one

...
const footerLinks = {
  explore: [
    { href: "/explore", label: "Monuments" },
    { href: "/explore?filter=unesco", label: "UNESCO Sites" },
    { href: "/explore?filter=temples", label: "Temples" },
    { href: "/explore?filter=forts", label: "Forts & Palaces" },
  ],
  community: [
...
const socialLinks = [
  { href: "#", label: "Twitter", icon: "M24 4.557..." },
...
export default function Footer() {
  return (
    <footer className="bg-gradient-to-b from-surface to-surface-warm border-t border-border">
      {/* Main Footer */}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-text-muted text-sm leading-relaxed mb-6 max-w-sm">
              Dedicated to documenting, preserving, and celebrating India&apos;s
              magnificent cultural heritage. Join us in protecting our shared
            ...
            <div className="flex gap-3">
              {["twitter", "instagram", "facebook", "youtube"].map((social) => (
                <a
                  key={social}
                  href="#"
                  className="w-10 h-10 rounded-full bg-white border border-border flex items-center justify-center text-text-muted hover:text-primary hover:border-primary transition-all duration-300 hover:-translate-y-1"
                  aria-label={social}
                >
          ...
          <div>
            <h4 className="font-heading font-semibold text-text mb-4">Community</h4>
            <ul className="space-y-2">
